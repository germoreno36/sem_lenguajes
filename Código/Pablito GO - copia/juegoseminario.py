...
# ------------------------------------------------------------------------        
    ...
    # ------------------------------------------------------------------------
        ...
        #while estado_app == 3
            #carga el fondo y todo lo del menu Gameplay
            #if clickear en VOLVER q es la unica opcion q va a tener esta pantalla
                #estado_app = 1
    ...
    while estado_app == 5:                                                      # 5 = Ganaste
        pygame.mixer.music.load("juego_de_tronos_version_guitarra.mp3")
        pygame.mixer.music.play(-1,0.0)
        ganaste = pygame.image.load("youwin.png")
        ganastex=0
        ganastey=0
        salir_ganaste = False
        ...
        while salir_ganaste == False:
            ...
            PANTALLA.blit(textopuntuaciontotal,(250,15))                            #
    ...
    while estado_app == 6:                                                      # 6 = Perdiste   
        pygame.mixer.music.load("Super_Mario_Bros._-_Game_Over_Sound_Effect.mp3")
        pygame.mixer.music.play(-1,0.0)
        perdiste = pygame.image.load("gameover.png")
        perdistex=0
        perdistey=0
